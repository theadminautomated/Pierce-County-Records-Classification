...
#
# These keywords are used by both the LLM validation logic and the
# lightweight heuristic classifier.  They have been expanded to cover a
# wide range of common record types referenced in the WA Schedule‑6
# guidelines.  The goal is to provide ample hints for classification
